package br.com.facamp.lakelevel;
...
public class LakeLevelPredictor {
    ...
    private String neuralNetworkModelFilePath = "lakeLevelPredictor.nnet";

    private static XYSeries graphDataset;

    public LakeLevelPredictor(int slidingWindowSize, String rawDataFilePath, double learningRate) {
...
//        List<LakeLevelPredictor> networks = new ArrayList<>();
//        for(int i = 1; i <= 10; i++) {
//            LakeLevelPredictor predictor = new LakeLevelPredictor(i, 
//                    "input/rawTrainingData.csv", 0.7);
...
//        }
//        
//        for (LakeLevelPredictor network : networks)
...
//        
//        for(int i = 1; i <= 10; i++) {
//            LakeLevelPredictor predictor = new LakeLevelPredictor(4,
